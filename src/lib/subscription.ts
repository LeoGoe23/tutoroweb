...
export const subscriptionPlans: SubscriptionPlan[] = [
  {
    ...
    currency: "EUR",
    interval: "month",
    features: ["5 Nachhilfe-Sessions pro Monat", "Basis Support", "Standard Lernmaterialien", "Community Zugang"],
  },
  {
    id: "plus",
    name: "Plus",
    ...
    isPopular: true,
    features: [
      "Unbegrenzte Nachhilfe-Sessions",
...
export const subscriptionService = {
  ...
  createCheckoutSession: async (planId: SubscriptionTier, userId: string): Promise<{ url: string }> => {
    ...
    if (!plan?.stripePriceId) {
      throw new Error("Ungültiger Plan oder fehlende Stripe Preis-ID");
    }
