  ...
  <div class="test-card">
    ...
    <div class="test-section">
      ...
      <div class="test-actions">
        <button on:click={runAuthTests} class="btn primary">Run Tests</button>
...
<style>
  ...
  .current-state, .test-section, .instructions {
    margin: 2rem 0;
    padding: 1.5rem;
  ...
  .status.authenticated { background: #f0fdf4; color: #16a34a; }
  .status.unauthenticated { background: #fef2f2; color: #dc2626; }
